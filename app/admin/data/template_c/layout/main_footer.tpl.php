<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2015-10-09 18:26:16, compiled from D:\htdocs\grape/app/admin/template/layout/main_footer.htm */ ?>
			</section>
        </div>
    </div>
	...
	<!--Footer-part-->
    <div class="row-fluid">
      <div id="footer" class="span12"> 2015 &copy; Grape Admin. Brought to you by</div>
    </div>
    <!--end-Footer-part-->
    <!--提示正在载入中的效果-->
    ...
    <?php if  (!empty($hidden_init_token)) { ?>
    <input type="hidden" id="init_token" name="init_token" value="<?php echo $hidden_init_token ?>" />
    <?php } ?>
